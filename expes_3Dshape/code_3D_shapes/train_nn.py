...
from tensorflow.keras.losses import MeanAbsoluteError, MeanSquaredLogarithmicError, CosineSimilarity, MeanSquaredError
...
print(sys.path)
from helper_fctns.get_names import get_dirs_results, get_dir_model
