...
lens = mapper.fit_transform(Xfilt, projection=sklearn.manifold.MDS(verbose=1)) #dimensionality reduction of Xfilt
...
html = mapper.visualize(
    graph,
    path_html="C:/Code/src/Mapper_for_TDA/mapper.html",
    title="mapper data",
