...
def ripser_train(X_train, thresh, graph_indicators, df_edges, step_size):  # this is for the train data
    start2 = time()
    train_betti = []
    graph_density = []
    graph_diameter = []
...
def ripser_test(X_test, thresh, graph_indicators, df_edges, step_size, train_time):  # this is for the train test
    start3 = time()
    test_betti = []
    test_graph_density = []
    test_graph_diameter = []
...
def main():
    ...
    train_data, train_time = ripser_train(X_train, thresh, graph_indicators, df_edges, step_size)
    test_data, ripser_time = ripser_test(X_test, thresh, graph_indicators, df_edges, step_size, train_time)
...
if __name__ == '__main__':
    ...
    outputFile = "../../../results/" + 'betti1_graph.csv'
