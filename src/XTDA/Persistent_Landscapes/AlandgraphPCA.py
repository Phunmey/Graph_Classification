...
def landscape_train(X_train, thresh, graph_indicators, df_edges, step_size):  # this is for the train data
    start2 = time()
    train_silhouette = []
    graph_density = []
    graph_diameter = []
...
def random_forest(dataset, Param_Grid, train_data, test_data, y_train, y_test, silhouette_time, thresh, num_cv, step_size):
    ...
    print(f'Ripser took {silhouette_time} seconds, training took {training_time} seconds')
...
def main():
    ...
    train_data, train_time, sample_range = landscape_train(X_train, thresh, graph_indicators, df_edges, step_size)
    ...
    random_forest(dataset, Param_Grid, train_data, test_data, y_train, y_test, silhouette_time, thresh, num_cv, step_size)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results/" + 'AsilhgraphPCA.csv'
