...
def standardGraphFile(dataset, file, data_path, iter, step):
    ...
    for i in train_set:
        ...
        embedding = TSNE(n_components=3, init='pca', learning_rate='auto').fit_transform(
            train_dist_matrix)  # dimension reduction
    ...
    for w in test_set:
        ...
        test_embedding = TSNE(n_components=3, init='pca', learning_rate='auto').fit_transform(test_dist_matrix)
...
if __name__ == '__main__':
    ...
    outputFile = "../results/" + 'TSNEResults.csv'
